...
## Aprire la fonte da una scheda percorso

Sulle schede **Lauree**, **Master** e **Corsi online** il pulsante **Sorgente** (in alto, accanto ad Anteprima) apre l'URL della `data_source` collegata. Serve a verificare i dati scrapati senza uscire dal flusso di revisione.
